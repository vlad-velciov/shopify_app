...
module ShopifyApp
  class SessionsControllerTest < ActionController::TestCase
    ...
    test '#new stores the relative path for return_to in the session' do
      get :new, params: { shop: 'my-shop', return_to: '///example.com' }
      assert_equal '/example.com', session[:return_to]

      get :new, params: { shop: 'my-shop', return_to: 'https://evil.com/somepath' }
      assert_equal '/somepath', session[:return_to]
    end
